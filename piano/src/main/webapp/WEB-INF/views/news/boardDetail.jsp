...
<script type="text/javascript">
    ...
    function goBoardUpdate(){
        ...
        location.href = "/news/boardUpdate?boardSeq="+ boardSeq;
    }
	...
	function goBoardReply(){
		...
		location.href = "/news/boardReply?boardSeq="+ boardSeq;
	}
	/** 게시판 - 첨부파일 다운로드 */
    function fileDownload(fileNameKey, fileName, filePath){
            
        location.href = "/news/fileDownload?fileNameKey="+fileNameKey+"&fileName="+fileName+"&filePath="+filePath;
    }
