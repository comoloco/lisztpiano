        ...
        if(obj != null){                                
            ...
            if(filesLen > 0){
                ...
                for(var a=0; a<filesLen; a++){
                    ...
                    str += "<td colspan='3'><img style='width:300px;height:300px' src=/resources/img/"+fileNameKey+"><a href='/board/fileDownload?fileNameKey="+encodeURI(fileNameKey)+"&fileName="+encodeURI(fileName)+"&filePath="+encodeURI(filePath)+"'>" + fileName + "</a></td>";
                    str += "</tr>";
                }    
            }            
