        ...
        if(obj != null){                                
            ...
            if(filesLen > 0){
            	...
            	for(var a=0; a<filesLen; a++){
                    ...
                    fileStr += "<a href='/news/fileDownload?fileNameKey="+encodeURI(fileNameKey)+"&fileName="+encodeURI(fileName)+"&filePath="+encodeURI(filePath)+"'>" + fileName + "</a>";
                ...
                <caption><strong><span class="t_red">*</span> 표시는 필수입력 항목입니다.</strong></caption>
                    ...
                    <tbody id="tbody">
                       <tr>
                         ...
                         <tr>
                            <th>작성자</th>
                            <td id="board_writer"><input id="board_writer" name="board_writer" value="${loginInfo.get('uid')}"
